...
- SvelteKit 2 + Svelte 5 for framework (Phase 1)
...
- Node radius 20px with labels below for clean appearance (Phase 4)
- SVG max-width constraint to prevent over-scaling (Phase 4)
